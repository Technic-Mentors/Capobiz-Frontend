...
function FAQs() {
  ...
  const handleAccordionToggle = (column, accordionId) => {
    if (column === 'left') {
      setActiveAccordionLeft(activeAccordionLeft === accordionId ? null : accordionId);
    } else if (column === 'right') {
      setActiveAccordionRight(activeAccordionRight === accordionId ? null : accordionId);
    }
  };
          ...
          <div className="row">
            ...
            <div className="col-md-6" data-aos="fade-right" data-aos-offset="200" data-aos-duration="1200">
              <div className="accordion" id="accordionPanelsStayOpenExampleLeft">
                <div className="accordion-item">
                  <h2 className={`accordion-header ${activeAccordionLeft !== 1 ? 'closed' : ''}`} id="headingOneLeft">
                    <button
                      ...
                      aria-expanded={activeAccordionLeft === 1 ? 'true' : 'false'}
                      onClick={() => handleAccordionToggle('left', 1)}
                      data-bs-speed="500"
                      style={{ backgroundColor: activeAccordionLeft === 1 ? "#fff" : "var(--secondary-color)", height: '60px', borderRadius: '20px',
                      color: activeAccordionLeft === 1 ? "var(--primary-color)" : "#fff"}}
                    >
                  ...
                  >
                    <div className="accordion-body">
                      <p>CapoBiz POS software is equipped with a comprehensive set of features including inventory management, sales tracking, employee management, customer data tracking, and real-time reporting. It supports various payment methods and can be customized to meet specific business needs.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  <h2 className={`accordion-header ${activeAccordionLeft !== 2 ? 'closed' : ''}`} id="headingTwoLeft">
                    <button
                      ...
                      aria-expanded={activeAccordionLeft === 2 ? 'true' : 'false'}
                      onClick={() => handleAccordionToggle('left', 2)}
                      data-bs-speed="500"
                      style={{ backgroundColor: activeAccordionLeft === 2 ? "#fff" : "var(--secondary-color)", height: '60px', borderRadius: '20px',
                      color: activeAccordionLeft === 2 ? "var(--primary-color)" : "#fff" }}
                    >
                ...
                >
                <div className="accordion-body">
                  <p>Yes, our POS software is designed to be hardware-agnostic and can seamlessly integrate with a variety of devices, including barcode scanners, receipt printers, cash registers, and more. This flexibility ensures compatibility with your existing equipment or allows for easy upgrades.</p>
                </div>
              </div>
                </div>
                ...
                <div className="accordion-item">
                  <h2 className={`accordion-header ${activeAccordionLeft !== 3 ? 'closed' : ''}`} id="headingThreeLeft">
                    <button
                      ...
                      aria-expanded={activeAccordionLeft === 3 ? 'true' : 'false'}
                      onClick={() => handleAccordionToggle('left', 3)}
                      data-bs-speed="500"
                      style={{ backgroundColor: activeAccordionLeft === 3 ? "#fff" : "var(--secondary-color)", height: '60px', borderRadius: '20px',
                      color: activeAccordionLeft === 3 ? "var(--primary-color)" : "#fff" }}
                  >
                ...
                <div
                  ...
                  >
                <div className="accordion-body">
                  <p>Security is a top priority for us. Our POS software employs robust encryption protocols to safeguard sensitive information. Regular security updates and compliance with industry standards ensure that your data is protected against potential threats.</p>
          </div>
      </div>
    </div>        
  </div>
                ...
                <div className="accordion-item">
                  <h2 className={`accordion-header ${activeAccordionRight !== 4 ? 'closed' : ''}`} id="headingOneRight">
                    <button
                      ...
                      aria-expanded={activeAccordionRight === 4 ? 'true' : 'false'}
                      onClick={() => handleAccordionToggle('right', 4)}
                      data-bs-speed="500"
                      style={{ backgroundColor: activeAccordionRight === 4 ? "#fff" : "var(--secondary-color)", height: '60px', borderRadius: '20px',
                      color: activeAccordionRight === 4 ? "var(--primary-color)" : "#fff" }}
                    >
                  ...
                  >
                    <div className="accordion-body">
                      <p>Absolutely! Our POS system is highly customizable. Whether you run a retail store, restaurant, or any other business, we provide options to tailor the software to meet your unique requirements. Our team can work with you to configure the software according to your business processes.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  <h2 className={`accordion-header ${activeAccordionRight !== 5 ? 'closed' : ''}`} id="headingTwoRight">
                    <button
                      ...
                      aria-expanded={activeAccordionRight === 5 ? 'true' : 'false'}
                      onClick={() => handleAccordionToggle('right', 5)}
                      data-bs-speed="500"
                      style={{ backgroundColor: activeAccordionRight === 5 ? "#fff" : "var(--secondary-color)", height: '60px', borderRadius: '20px',
                      color: activeAccordionRight === 5 ? "var(--primary-color)" : "#fff" }}
                    >
                  ...
                  >
                  <div className="accordion-body">
                    <p>Yes, we offer comprehensive training to ensure a smooth onboarding process for your team. Additionally, our support team is available to assist you with any queries or issues that may arise. We are committed to providing excellent customer support to help you make the most out of our POS solution.</p>
            </div>
        </div>
                </div>
                ...
                <div className="accordion-item">
                  <h2 className={`accordion-header ${activeAccordionRight !== 6 ? 'closed' : ''}`} id="headingThreeRight">
                    <button
                      ...
                      aria-expanded={activeAccordionRight === 6 ? 'true' : 'false'}
                      onClick={() => handleAccordionToggle('right', 6)}
                      data-bs-speed="500"
                      style={{ backgroundColor: activeAccordionRight === 6 ? "#fff" : "var(--secondary-color)", height: '60px', borderRadius: '20px',
                      color: activeAccordionRight === 6 ? "var(--primary-color)" : "#fff" }}
                    >
                   ...
                   <div
                    ...
                    >
                    <div className="accordion-body">
                     <p>We are dedicated to continuous improvement. Updates and enhancements to our POS software are released regularly to incorporate new features, address security concerns, and improve overall performance. Customers with active subscriptions receive these updates automatically, ensuring they always have access to the latest capabilities.</p>
                    </div>
                </div>
                </div>
